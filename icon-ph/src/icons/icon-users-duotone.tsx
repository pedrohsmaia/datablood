...
const IconUsersDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path d="M136 108a52 52 0 1 1-52-52 52 52 0 0 1 52 52" opacity={0.2} />
...
const Memo = memo(themed(IconUsersDuotone))
export { Memo as IconUsersDuotone }
