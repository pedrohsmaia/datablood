...
const IconSpiralDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M240 144h-32a80 80 0 0 1-80 80 88 88 0 0 1-88-88 96 96 0 0 1 96-96 104 104 0 0 1 104 104"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconSpiralDuotone))
export { Memo as IconSpiralDuotone }
