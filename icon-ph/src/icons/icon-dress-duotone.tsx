...
const IconDressDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M200 224H56a8 8 0 0 1-7.35-11.15L96 112 73.14 76.12a8 8 0 0 1 0-8.24L96 35.23l7 8.77a32 32 0 0 0 50 0l7-8.76 22.86 32.65a8 8 0 0 1 0 8.24L160 112l47.34 100.85A8 8 0 0 1 200 224"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconDressDuotone))
export { Memo as IconDressDuotone }
