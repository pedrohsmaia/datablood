...
const IconHandSoapDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M208 136v80a8 8 0 0 1-8 8H56a8 8 0 0 1-8-8v-80a32 32 0 0 1 32-32h96a32 32 0 0 1 32 32"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconHandSoapDuotone))
export { Memo as IconHandSoapDuotone }
