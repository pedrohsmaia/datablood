...
const IconAirplaneLandingDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M224 148.32V184L47.37 134.54A32 32 0 0 1 24 103.73V48a8 8 0 0 1 10.53-7.59L40 42.24l12 33.22L96 88V48a8 8 0 0 1 10.53-7.59l5.47 1.83 24 57.2 64.56 18A32 32 0 0 1 224 148.32"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconAirplaneLandingDuotone))
export { Memo as IconAirplaneLandingDuotone }
