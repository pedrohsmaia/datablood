...
const IconUniteDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M232 160a72 72 0 0 1-143.6 7.6 72 72 0 1 1 79.2-79.2A72 72 0 0 1 232 160"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconUniteDuotone))
export { Memo as IconUniteDuotone }
