...
const IconUsbDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M160 64a24 24 0 1 1-24-24 24 24 0 0 1 24 24m40 32v64l48-32Zm-48 72h-32a8 8 0 0 0-8 8v32a8 8 0 0 0 8 8h32a8 8 0 0 0 8-8v-32a8 8 0 0 0-8-8"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconUsbDuotone))
export { Memo as IconUsbDuotone }
