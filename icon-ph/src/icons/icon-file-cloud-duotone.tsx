...
const IconFileCloudDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M208 88h-56V32Zm-100 48a44 44 0 0 0-42.34 32H60a28 28 0 0 0 0 56h48a44 44 0 0 0 0-88"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconFileCloudDuotone))
export { Memo as IconFileCloudDuotone }
