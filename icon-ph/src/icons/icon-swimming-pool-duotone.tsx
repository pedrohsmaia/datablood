...
const IconSwimmingPoolDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M224 168v40c-24 0-24 16-48 16s-24-16-48-16-24 16-48 16-24-16-48-16v-40c24 0 24 16 48 16s24-16 48-16 24 16 48 16 24-16 48-16"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconSwimmingPoolDuotone))
export { Memo as IconSwimmingPoolDuotone }
