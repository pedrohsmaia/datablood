...
const IconAirplaneTiltDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="m209 81-33 31 32 88-24 24-48-72-24 24v24l-24 24-16-40-40-16 24-24h24l24-24-72-48 24-24 88 32 31-33a24 24 0 0 1 34 34"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconAirplaneTiltDuotone))
export { Memo as IconAirplaneTiltDuotone }
