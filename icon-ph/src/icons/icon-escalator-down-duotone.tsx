...
const IconEscalatorDownDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M232 160v40a8 8 0 0 1-8 8h-52.5a8 8 0 0 1-5.88-2.57l-91.24-98.86A8 8 0 0 0 68.5 104H32a8 8 0 0 1-8-8V56a8 8 0 0 1 8-8h52.5a8 8 0 0 1 5.88 2.57l91.24 98.86a8 8 0 0 0 5.88 2.57H224a8 8 0 0 1 8 8"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconEscalatorDownDuotone))
export { Memo as IconEscalatorDownDuotone }
