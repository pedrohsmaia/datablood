...
const IconCurrencyEurDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M184 58.33v139.34A72 72 0 0 1 64 144v-32a72 72 0 0 1 120-53.67"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconCurrencyEurDuotone))
export { Memo as IconCurrencyEurDuotone }
