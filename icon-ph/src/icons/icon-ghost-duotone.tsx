...
const IconGhostDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M216 120v96l-29.33-24-29.34 24L128 192l-29.33 24-29.34-24L40 216v-96a88 88 0 0 1 176 0"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconGhostDuotone))
export { Memo as IconGhostDuotone }
