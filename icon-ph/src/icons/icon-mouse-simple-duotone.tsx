...
const IconMouseSimpleDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M200 80v96a56 56 0 0 1-56 56h-32a56 56 0 0 1-56-56V80a56 56 0 0 1 56-56h32a56 56 0 0 1 56 56"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconMouseSimpleDuotone))
export { Memo as IconMouseSimpleDuotone }
