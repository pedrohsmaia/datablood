...
const IconCaretCircleDoubleRightDuotone = (_props: any) => {
...
const Memo = memo(themed(IconCaretCircleDoubleRightDuotone))
export { Memo as IconCaretCircleDoubleRightDuotone }
