...
const IconPaypalLogoDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M191.91 82.7a49 49 0 0 1-1.37 8.94A48 48 0 0 1 144 128h-36a8 8 0 0 0-7.76 6.06l12-48A8 8 0 0 1 120 80h56a48.25 48.25 0 0 1 15.91 2.7"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconPaypalLogoDuotone))
export { Memo as IconPaypalLogoDuotone }
