...
const IconMonitorPlayDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M208 48H48a16 16 0 0 0-16 16v112a16 16 0 0 0 16 16h160a16 16 0 0 0 16-16V64a16 16 0 0 0-16-16m-96 104V88l48 32Z"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconMonitorPlayDuotone))
export { Memo as IconMonitorPlayDuotone }
