...
const IconOfficeChairDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M176 136H80a8 8 0 0 1-7.92-9.13l13.72-96A8 8 0 0 1 93.72 24h68.56a8 8 0 0 1 7.92 6.87l13.72 96A8 8 0 0 1 176 136"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconOfficeChairDuotone))
export { Memo as IconOfficeChairDuotone }
