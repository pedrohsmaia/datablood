...
const IconTrafficSignDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M237.49 134.05 134.05 237.49a8.54 8.54 0 0 1-12.1 0L18.51 134.05a8.54 8.54 0 0 1 0-12.1L122 18.51a8.54 8.54 0 0 1 12.1 0L237.49 122a8.54 8.54 0 0 1 0 12.05"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconTrafficSignDuotone))
export { Memo as IconTrafficSignDuotone }
