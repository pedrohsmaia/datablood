...
const IconTextAaDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M232 164c0 15.46-14.33 28-32 28s-32-12.54-32-28 14.33-28 32-28 32 12.54 32 28M34.82 152h90.36L80 56Z"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconTextAaDuotone))
export { Memo as IconTextAaDuotone }
