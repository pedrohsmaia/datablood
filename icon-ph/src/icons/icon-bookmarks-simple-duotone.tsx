...
const IconBookmarksSimpleDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M168 72v152l-56-40-56 40V72a8 8 0 0 1 8-8h96a8 8 0 0 1 8 8"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconBookmarksSimpleDuotone))
export { Memo as IconBookmarksSimpleDuotone }
