...
const IconBellSimpleRingingDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M208 192H48a8 8 0 0 1-6.88-12C47.71 168.6 56 147.81 56 112a72 72 0 0 1 144 0c0 35.82 8.3 56.6 14.9 68a8 8 0 0 1-6.9 12"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconBellSimpleRingingDuotone))
export { Memo as IconBellSimpleRingingDuotone }
