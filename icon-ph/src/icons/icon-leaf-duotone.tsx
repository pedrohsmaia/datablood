...
const IconLeafDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M63.81 192.19c-47.89-79.81 16-159.62 151.64-151.64 7.98 135.68-71.83 199.53-151.64 151.64"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconLeafDuotone))
export { Memo as IconLeafDuotone }
