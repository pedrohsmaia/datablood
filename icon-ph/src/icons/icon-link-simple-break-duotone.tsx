...
const IconLinkSimpleBreakDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="m209.94 113.94-96 96a48 48 0 0 1-67.88-67.88l96-96a48 48 0 0 1 67.88 67.88"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconLinkSimpleBreakDuotone))
export { Memo as IconLinkSimpleBreakDuotone }
