...
const IconSuitcaseRollingDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M200 64v144a8 8 0 0 1-8 8H64a8 8 0 0 1-8-8V64a8 8 0 0 1 8-8h128a8 8 0 0 1 8 8"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconSuitcaseRollingDuotone))
export { Memo as IconSuitcaseRollingDuotone }
