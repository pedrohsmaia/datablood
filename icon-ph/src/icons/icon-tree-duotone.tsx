...
const IconTreeDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M232 127.82a64 64 0 0 1-99.52 53.41 8 8 0 0 0-9 0A64 64 0 1 1 61.25 69.86a8 8 0 0 0 4-4.17 68 68 0 0 1 125.44 0 8 8 0 0 0 4 4.17A64 64 0 0 1 232 127.82"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconTreeDuotone))
export { Memo as IconTreeDuotone }
