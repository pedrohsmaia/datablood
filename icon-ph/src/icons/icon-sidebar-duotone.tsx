...
const IconSidebarDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path d="M88 48v160H40a8 8 0 0 1-8-8V56a8 8 0 0 1 8-8Z" opacity={0.2} />
...
const Memo = memo(themed(IconSidebarDuotone))
export { Memo as IconSidebarDuotone }
