...
const IconCubeTransparentDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path d="M216 96v120H96l-56-56V40h120Z" opacity={0.2} />
...
const Memo = memo(themed(IconCubeTransparentDuotone))
export { Memo as IconCubeTransparentDuotone }
