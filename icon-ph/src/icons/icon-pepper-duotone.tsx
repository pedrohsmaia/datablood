...
const IconPepperDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M214.83 92.58 192 104l-32-16-32 16-22.83-11.42a56 56 0 0 1 109.66 0"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconPepperDuotone))
export { Memo as IconPepperDuotone }
