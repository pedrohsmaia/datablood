...
const IconBugDroidDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path d="M208 120v24a80 80 0 0 1-160 0v-24Z" opacity={0.2} />
...
const Memo = memo(themed(IconBugDroidDuotone))
export { Memo as IconBugDroidDuotone }
