...
const IconFlowerTulipDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M169.23 66A80 80 0 0 0 128 136a80 80 0 0 0-41.23-70C100 38 128 24 128 24s28 14 41.23 42"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconFlowerTulipDuotone))
export { Memo as IconFlowerTulipDuotone }
