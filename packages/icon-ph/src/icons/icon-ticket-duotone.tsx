...
const IconTicketDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M200 128a32 32 0 0 0 25.6 31.36 8 8 0 0 1 6.4 7.83V192a8 8 0 0 1-8 8H96V56h128a8 8 0 0 1 8 8v24.81a8 8 0 0 1-6.4 7.83A32 32 0 0 0 200 128"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconTicketDuotone))
export { Memo as IconTicketDuotone }
