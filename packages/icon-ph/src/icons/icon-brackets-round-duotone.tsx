...
const IconBracketsRoundDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M224 128c0 64-40 88-40 88H72s-40-24-40-88 40-88 40-88h112s40 24 40 88"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconBracketsRoundDuotone))
export { Memo as IconBracketsRoundDuotone }
