...
const IconCheckSquareOffsetDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M216 48v160a8 8 0 0 1-8 8H64l-24-24V48a8 8 0 0 1 8-8h160a8 8 0 0 1 8 8"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconCheckSquareOffsetDuotone))
export { Memo as IconCheckSquareOffsetDuotone }
