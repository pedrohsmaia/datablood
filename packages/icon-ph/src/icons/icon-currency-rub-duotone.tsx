...
const IconCurrencyRubDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M200 92a52 52 0 0 1-52 52H88V40h60a52 52 0 0 1 52 52"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconCurrencyRubDuotone))
export { Memo as IconCurrencyRubDuotone }
