...
const IconHeartBreakDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M232 94c0 66-104 122-104 122S24 160 24 94a54 54 0 0 1 92.18-38.18L128 67.63l11.82-11.81A54 54 0 0 1 232 94"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconHeartBreakDuotone))
export { Memo as IconHeartBreakDuotone }
