...
const IconFlagCheckeredDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M216 48v64c-19.89 17.23-38.23 18.39-56 13.48v-64c17.76 4.91 36.11 3.75 56-13.48M96 98.52v-64C78.24 29.61 59.89 30.77 40 48v64c19.89-17.22 38.23-18.39 56-13.48v56c21.62 6 42.38 21 64 27v-56c-21.62-6-42.38-21-64-27"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconFlagCheckeredDuotone))
export { Memo as IconFlagCheckeredDuotone }
