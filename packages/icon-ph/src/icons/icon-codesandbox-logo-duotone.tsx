...
const IconCodesandboxLogoDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M32 125.73 80 152v54.84l-43.84-24a8 8 0 0 1-4.16-7ZM176 152v54.84l43.84-24a8 8 0 0 0 4.16-7v-50.1ZM124.16 25l-41 22.46L128 72l44.86-24.56L131.84 25a8 8 0 0 0-7.68 0"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconCodesandboxLogoDuotone))
export { Memo as IconCodesandboxLogoDuotone }
