...
const IconLineSegmentDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M81 175a24 24 0 1 1-34 0 24 24 0 0 1 34 0M209 47a24 24 0 1 0 0 34 24 24 0 0 0 0-34"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconLineSegmentDuotone))
export { Memo as IconLineSegmentDuotone }
