...
const IconEscalatorUpDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M232 56v40a8 8 0 0 1-8 8h-36.5a8 8 0 0 0-5.88 2.57l-91.24 98.86A8 8 0 0 1 84.5 208H32a8 8 0 0 1-8-8v-40a8 8 0 0 1 8-8h36.5a8 8 0 0 0 5.88-2.57l91.24-98.86A8 8 0 0 1 171.5 48H224a8 8 0 0 1 8 8"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconEscalatorUpDuotone))
export { Memo as IconEscalatorUpDuotone }
