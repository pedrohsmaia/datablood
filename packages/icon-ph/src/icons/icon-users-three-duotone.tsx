...
const IconUsersThreeDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M168 144a40 40 0 1 1-40-40 40 40 0 0 1 40 40M64 56a32 32 0 1 0 32 32 32 32 0 0 0-32-32m128 0a32 32 0 1 0 32 32 32 32 0 0 0-32-32"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconUsersThreeDuotone))
export { Memo as IconUsersThreeDuotone }
