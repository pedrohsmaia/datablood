...
const IconCodepenLogoDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path d="m232 160-104 56-104-56 104-56Z" opacity={0.2} />
...
const Memo = memo(themed(IconCodepenLogoDuotone))
export { Memo as IconCodepenLogoDuotone }
