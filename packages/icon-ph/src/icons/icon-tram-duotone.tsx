...
const IconTramDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M208 80v48H48V80a24 24 0 0 1 24-24h112a24 24 0 0 1 24 24"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconTramDuotone))
export { Memo as IconTramDuotone }
