...
const IconSlidersDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M80 136a24 24 0 1 1-24-24 24 24 0 0 1 24 24m48-72a24 24 0 1 0 24 24 24 24 0 0 0-24-24m72 80a24 24 0 1 0 24 24 24 24 0 0 0-24-24"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconSlidersDuotone))
export { Memo as IconSlidersDuotone }
