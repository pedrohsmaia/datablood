...
const IconMoonStarsDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M210.69 158.18A88 88 0 1 1 97.82 45.31 96.08 96.08 0 0 0 192 160a96.78 96.78 0 0 0 18.69-1.82"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconMoonStarsDuotone))
export { Memo as IconMoonStarsDuotone }
