...
const IconCaretCircleDoubleDownDuotone = (_props: any) => {
...
const Memo = memo(themed(IconCaretCircleDoubleDownDuotone))
export { Memo as IconCaretCircleDoubleDownDuotone }
