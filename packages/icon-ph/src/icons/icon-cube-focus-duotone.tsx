...
const IconCubeFocusDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M184 98.57v58.86a5 5 0 0 1-2.43 4.32l-51.33 29.65a4.48 4.48 0 0 1-4.48 0l-51.33-29.65a5 5 0 0 1-2.43-4.32V98.57a5 5 0 0 1 2.43-4.32l51.33-29.65a4.48 4.48 0 0 1 4.48 0l51.33 29.65a5 5 0 0 1 2.43 4.32"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconCubeFocusDuotone))
export { Memo as IconCubeFocusDuotone }
