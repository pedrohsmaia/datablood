...
const IconSynagogueDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M216 80v32h-32V80a16 16 0 0 1 16-16 16 16 0 0 1 16 16M72 80a16 16 0 0 0-16-16 16 16 0 0 0-16 16v32h32Zm0 56v80h40v-40a16 16 0 0 1 16-16 16 16 0 0 1 16 16v40h40v-80l-56-32Z"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconSynagogueDuotone))
export { Memo as IconSynagogueDuotone }
