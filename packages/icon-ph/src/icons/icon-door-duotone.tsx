...
const IconDoorDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M200 40v184H56V40a8 8 0 0 1 8-8h128a8 8 0 0 1 8 8"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconDoorDuotone))
export { Memo as IconDoorDuotone }
