...
const IconCoinsDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M240 132c0 19.88-35.82 36-80 36-19.6 0-37.56-3.17-51.47-8.44C146.76 156.85 176 142 176 124V96.72c36.52 3.34 64 17.86 64 35.28m-64-48c0-19.88-35.82-36-80-36S16 64.12 16 84s35.82 36 80 36 80-16.12 80-36"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconCoinsDuotone))
export { Memo as IconCoinsDuotone }
