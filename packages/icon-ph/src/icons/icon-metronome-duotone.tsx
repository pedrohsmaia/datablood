...
const IconMetronomeDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M200 216H56a8 8 0 0 1-7.63-10.43l12-37.57h135.29l12 37.57A8 8 0 0 1 200 216"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconMetronomeDuotone))
export { Memo as IconMetronomeDuotone }
