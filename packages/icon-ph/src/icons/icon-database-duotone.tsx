...
const IconDatabaseDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M216 80c0 26.51-39.4 48-88 48s-88-21.49-88-48 39.4-48 88-48 88 21.49 88 48"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconDatabaseDuotone))
export { Memo as IconDatabaseDuotone }
