...
const IconClockCounterClockwiseDuotone = (_props: any) => {
...
const Memo = memo(themed(IconClockCounterClockwiseDuotone))
export { Memo as IconClockCounterClockwiseDuotone }
