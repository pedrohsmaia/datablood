...
const IconWheelchairDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path d="M128 48a24 24 0 1 1-24-24 24 24 0 0 1 24 24" opacity={0.2} />
...
const Memo = memo(themed(IconWheelchairDuotone))
export { Memo as IconWheelchairDuotone }
