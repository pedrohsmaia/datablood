...
const IconLighthouseDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M181.61 112H74.39L80 56h96ZM192 215.24 187.23 168H68.77L64 215.24a8 8 0 0 0 8 8.76h112a8 8 0 0 0 8-8.76"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconLighthouseDuotone))
export { Memo as IconLighthouseDuotone }
