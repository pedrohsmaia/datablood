...
const IconBatteryVerticalMediumDuotone = (_props: any) => {
...
const Memo = memo(themed(IconBatteryVerticalMediumDuotone))
export { Memo as IconBatteryVerticalMediumDuotone }
