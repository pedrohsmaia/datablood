...
const IconBalloonDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M137.89 199.13 152 232h-48l14.09-32.87C78.59 192.18 48 144.83 48 104a80 80 0 0 1 160 0c0 40.83-30.59 88.18-70.11 95.13"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconBalloonDuotone))
export { Memo as IconBalloonDuotone }
