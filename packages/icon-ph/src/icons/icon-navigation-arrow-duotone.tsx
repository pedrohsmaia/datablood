...
const IconNavigationArrowDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="m226.35 121-76.55 23.5a8 8 0 0 0-5.3 5.3L121 226.35a8 8 0 0 1-15.21.27l-65.28-176a8 8 0 0 1 10.12-10.16l176 65.28a8 8 0 0 1-.28 15.26"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconNavigationArrowDuotone))
export { Memo as IconNavigationArrowDuotone }
