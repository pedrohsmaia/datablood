...
const IconVaultDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M216 48H40a8 8 0 0 0-8 8v136a8 8 0 0 0 8 8h176a8 8 0 0 0 8-8V56a8 8 0 0 0-8-8m-64 120a40 40 0 1 1 40-40 40 40 0 0 1-40 40"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconVaultDuotone))
export { Memo as IconVaultDuotone }
