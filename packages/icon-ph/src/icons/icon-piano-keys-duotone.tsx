...
const IconPianoKeysDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path d="M184 40v104h-40V40ZM72 144h40V40H72Z" opacity={0.2} />
...
const Memo = memo(themed(IconPianoKeysDuotone))
export { Memo as IconPianoKeysDuotone }
