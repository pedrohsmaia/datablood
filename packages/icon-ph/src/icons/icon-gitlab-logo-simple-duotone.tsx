...
const IconGitlabLogoSimpleDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="m203.52 171.52-73.26 51.76a3.91 3.91 0 0 1-4.52 0l-73.26-51.76a49 49 0 0 1-18.87-52.4L53.5 43a3.93 3.93 0 0 1 7.5-.38L80.65 96h94.7L195 42.62a3.93 3.93 0 0 1 7.53.38l19.89 76.12a49 49 0 0 1-18.9 52.4"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconGitlabLogoSimpleDuotone))
export { Memo as IconGitlabLogoSimpleDuotone }
