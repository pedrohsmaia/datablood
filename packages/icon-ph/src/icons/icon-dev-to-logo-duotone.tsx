...
const IconDevToLogoDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M240 72v112a8 8 0 0 1-8 8H24a8 8 0 0 1-8-8V72a8 8 0 0 1 8-8h208a8 8 0 0 1 8 8"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconDevToLogoDuotone))
export { Memo as IconDevToLogoDuotone }
