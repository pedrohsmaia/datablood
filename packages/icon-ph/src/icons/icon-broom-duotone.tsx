...
const IconBroomDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M192.8 165.12 43.93 105.57a110.88 110.88 0 0 1 17.54-23.19 8 8 0 0 1 8.67-1.81l25.38 10.28a16 16 0 0 0 20.82-9l21-53.1c4.15-10 15.47-15.33 25.63-11.53a20 20 0 0 1 11.51 26.39l-21.35 53.1a16 16 0 0 0 8.93 20.75L187 127.3a8 8 0 0 1 5 7.43V152a104.58 104.58 0 0 0 .8 13.12"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconBroomDuotone))
export { Memo as IconBroomDuotone }
