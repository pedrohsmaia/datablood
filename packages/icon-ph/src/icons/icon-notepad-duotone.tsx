...
const IconNotepadDuotone = (_props: any) => {
  const { size = 24, ...props } = _props
  return (
    <Svg width={size} height={size} viewBox="0 0 256 256" {...props}>
      <G fill="currentColor">
        <Path
          d="M208 48v152a24 24 0 0 1-24 24H72a24 24 0 0 1-24-24V48a8 8 0 0 1 8-8h144a8 8 0 0 1 8 8"
          opacity={0.2}
        />
...
const Memo = memo(themed(IconNotepadDuotone))
export { Memo as IconNotepadDuotone }
